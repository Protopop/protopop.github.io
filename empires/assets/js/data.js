...
var eastFields = {
    ...
    terrain: "Plains",
    music: "morning",
    urban: ['Bresk', 'VenAbbey', 'BasinWood'],
    urbanTypes: ['City', 'Church', 'Dungeon'],
    urbanDescription: ['A friendly city and the largest port in Nuju'],
    citizens: [breskCitizens],
    citiesGrid: [
        [-77.03, 55.38],
        [-75.60, 66.14],
        [-77.14, 60.16] //,//[-75.08, 53.84],
        //[-72.02, 53.83],
...
var battleIcon = L.Icon.Label.extend({
    options: {
        iconUrl: 'assets/img/icons/appicon.png',
        shadowUrl: null,
